...
class PianoTranscription(object):
    def __init__(self, model_type='Note_pedal', checkpoint_path=None, 
        ...
        if not os.path.exists(checkpoint_path) or os.path.getsize(checkpoint_path) < 1.6e7:
        ...
        self.onset_threshold = 0.3/17.5  # 0.3
        self.offset_threshod = 0.3/17.5  # 0.3
        self.frame_threshold = 0.1/17.5  # 0.1
        self.pedal_offset_threshold = 0.02/17.5  # 0.2
